...
public class GameManager : MonoBehaviour
{
	...
	public ETileStatus[,] _myFieldMartix;
    public int HP { get; private set; }
    public int EnemyHP { get; private set; }
    public EGameStatus GameStatus { get; private set; }

	public int[][,] m_All_Four_Deck ;
	public int[][,] m_All_Triple_Deck;
	public int[][,] m_All_Double_Deck;
	public int[][,] m_All_Single_Deck;
	public Ship m_s;
    ...
    public void OnStartSearchButtonDown()
    {
		if (CheckForAllShipsOnBoard ()) {           
			...
			ConnectToRandomRoom.OnJoinedRoom ();
		} else {
			Debug.Log ("Not all ships in board");
		}
    }
	...
	public void SetReturn(){
		...
		Debug.Log (_myFieldMartix.ToString());
	}
}
